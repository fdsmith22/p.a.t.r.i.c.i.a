 ...
 * Science-based personality assessment through indirect, creative questioning
 * Based on projective techniques, metaphorical reasoning, and implicit association
 */

export const lateralQuestions = {
    // Openness to Experience - measured through abstract thinking and creativity
    openness: [
        {
            id: 'o1',
    ...
    // Conscientiousness - measured through scenario planning and decision patterns
    conscientiousness: [
        {
            id: 'c1',
    ...
    // Extraversion - measured through energy sources and social imagination
    extraversion: [
        {
            id: 'e1',
    ...
    // Agreeableness - measured through moral dilemmas and cooperation scenarios
    agreeableness: [
        {
            id: 'a1',
    ...
    // Neuroticism - measured through stress responses and emotional regulation
    neuroticism: [
        {
            id: 'n1',
    ...
    // Mixed dimensions - complex scenarios measuring multiple traits
    mixed: [
        {
            id: 'm1',
    ...
    // Projective scenarios - deeper psychological patterns
    projective: [
        {
            id: 'p1',
...
/**
 * Get randomized lateral questions for assessment
 */
export function getLateralQuestions(count = 20) {
    const allQuestions = [
...
/**
 * Scoring weights for lateral questions
 * Maps responses to Big Five dimensions
 */
